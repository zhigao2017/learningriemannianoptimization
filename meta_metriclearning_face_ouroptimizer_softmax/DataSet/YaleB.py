...
class YaleB(data.Dataset):
    def __init__(self, filepath=None,train=True):
        ...
        self.train_data=np.load(filepath+'/YaleB_fea.npy')
        self.train_labels=np.load(filepath+'/YaleB_gnd.npy')
        self.train_labels_num=np.load(filepath+'/YaleB_gnd.npy')
        self.test_data=np.load(filepath+'/YaleB_fea.npy')
        self.test_labels=np.load(filepath+'/YaleB_gnd.npy')
        self.test_labels_num=np.load(filepath+'/YaleB_gnd.npy')
