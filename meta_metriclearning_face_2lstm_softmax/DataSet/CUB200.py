...
class MyData(data.Dataset):
    def __init__(self, root=None, label_txt=None,
        ...
        if label_txt is None:
            root = "/home/tensorflow/dist2T/gaozhi/deep_SPD_metric_learning/CUB_200_2011/cub_images/"
...
class CUB_200:
    def __init__(self, root=None, transform=None):
        ...
        root_ = '/home/tensorflow/dist2T/gaozhi/deep_SPD_metric_learning/CUB_200_2011/cub_images/'

        train_txt = os.path.join(root_, 'train.txt')
        test_txt = os.path.join(root_, 'test.txt')

        self.train = MyData(root_, label_txt=train_txt, transform=transform[0])
        self.test = MyData(root_, label_txt=test_txt, transform=transform[1])
